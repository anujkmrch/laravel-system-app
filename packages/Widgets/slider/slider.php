<?php 
if($widget->hasConfiguration('show_title') 
	or $widget->hasConfiguration('head')
	or $widget->hasConfiguration('lead')
	or (!empty($widget->getConfiguration('button_1_text','')))
	or (!empty($widget->getConfiguration('button_2_text','')))
): ?>
