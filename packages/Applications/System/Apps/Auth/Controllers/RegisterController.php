...
use System\Models\UserVerification;
...
class RegisterController extends Controller
{
    ...
    */
    ...
    public function showRegistrationForm()
    {
        ...
        SEO::setDescription(\Lang::get("SystemLang::authentication.seo.description.register"));
    ...
    protected function create(array $data)
    {
        ...
        $verification = new UserVerification(['code'=>md5(uniqid().microtime().$user->email),'expired_on'=>$expire]);
